...
( function()
{
	...
	}   // ----- end cleanUserRequestParameters() -----
		...
		init : function( editor )
		{
			...
			editor.on( 'instanceReady', function( evt )
			{
				...
				editor.on( 'mode', function( e )
				{
					...
					editor.element.on( 'keydown', function( event )
					{
						attachOnKeydown( editor, event );
					} );

					editor.element.on( 'drop', function()
					{
						autosaveEnable( editor );
					} );
					editor.element.on( 'input', function()
					{
						autosaveEnable( editor );
					} );
				} );
